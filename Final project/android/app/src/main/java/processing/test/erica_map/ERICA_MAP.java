...
/* autogenerated by Processing revision 1286 on 2022-12-16 */
...
public class ERICA_MAP extends PApplet {
...
float stage0back_amp = 1.0f;
float textBarSize = 0.1f;
long pTime = 0;
 ...
 public void stage1() {
  ...
  public void stage3() {
     ...
     if (textBarSize < 1.0f) {    // 대화 상자가 일정크기 만큼 계속 커짐
        textBarSize += 0.05f;
        pTime = millis();
     } else {
        fill(10);
 ...
 public void rock_scissors_paper() {
...
smooth(); }
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ERICA_MAP" };
    if (passedArgs != null) {
